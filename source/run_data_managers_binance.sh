...
symbols=("BTCUSDT" "ETHUSDT" "LTCUSDT" "DOGEUSDT" "BNBUSDT")
...
do
  ...
  nohup python3 ./source/data_manager_binance.py "$symbol" 1m >> "./logs/${symbol}_1m_output.log" 2>> "./logs/${symbol}_1m_error.log" &
done
